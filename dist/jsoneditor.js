...
JSONEditor.defaults.editors.select = JSONEditor.AbstractEditor.extend({
  ...
  setupSelect2: function() {
    ...
    if(this.jsoneditor.options.use_select2 && window.jQuery && window.jQuery.fn && window.jQuery.fn.select2 && (this.enum_options.length > 2 || (this.enum_options.length && this.enumSource))) {
